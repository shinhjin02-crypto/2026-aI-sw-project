...
#1. 컬렉션 두개 준비
collections = {
    "nvme": build_document("./10.LangChain/7.RAG/3.store/nvme.txt", "nvme"),
    "hbm": build_document("./10.LangChain/7.RAG/3.store/hbm.txt", "hbm"),
}
...
print("\n=== 'nvme' 컬렉션에서 이걸 물어보면? ===")
for d in search_in('nvme', query):
    print(F" -> [{d.metadata[collections]}] {d.page_content}")
